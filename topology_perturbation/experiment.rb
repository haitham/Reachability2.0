...
open "#{dataset}/deltaref.out", "w" do |f|
	sources.each do |source|
		targets.each do |target|
			puts "./Graph #{dataset}/#{dataset}_hsa_string.txt #{dataset}/#{dataset}_hsa_sources#{source}.txt #{dataset}/#{dataset}_hsa_targets#{target}.txt pmc pre"
